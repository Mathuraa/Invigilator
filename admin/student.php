			...
			<tbody>
				...
				?>
					<tr class="del_student<?php echo $fetch['stud_id']?>">
						<td>IT<?php echo $fetch['stud_no']?></td>
			...
			<div class="modal-content">
				<form method="POST" action="save_student.php" enctype="multipart/form-data">	
					...
					<div class="modal-body">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label>Student no - IT</label>
								<input oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type="number" maxlength="8" name="stud_no" class="form-control" required="required"place holder="IT/>
							</div>
							<div class="form-group">
								<label>Firstname</label>
