		...
		<div class="panel-body">
			<form method="POST">
				<div class="form-group">
					<label for="username">Student no - IT-XXXXXX</label>
					<input oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type="number" maxlength="8" name="stud_no" class="form-control" required="required"/>
				</div>
				<div class="form-group">
